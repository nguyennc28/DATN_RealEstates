<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserManager.ascx.cs" Inherits="RealEstate.Modules.UserManager" %>
    ...
    <asp:Panel ID="pnView" runat="server">
        ...
        <asp:DataGrid ID="grdUser" runat="server" Width="100%" CssClass="TableView"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="Gender" HeaderText="Giới tính" />
                <asp:BoundColumn DataField="Avatar" HeaderText="Ảnh đại diện" />
                <asp:BoundColumn DataField="Email" HeaderText="Email" ItemStyle-CssClass="Text" Visible="true" />
                <asp:BoundColumn DataField="Birthday" HeaderText="Sinh nhật" ItemStyle-CssClass="Number" Visible="true"></asp:BoundColumn>
                <asp:BoundColumn DataField="Address" HeaderText="Địa chỉ"></asp:BoundColumn>
                <asp:BoundColumn DataField="Address" HeaderText="Số điện thoại"></asp:BoundColumn>
