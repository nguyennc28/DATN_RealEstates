...
{
    public partial class AdjacentVilla : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                LoadSaleAdjacentVilla();
            }
        }

        private void LoadSaleAdjacentVilla()
        {
            string chuoi = "";
            List<HomeInfo> listApartmentInfos = new List<HomeInfo>();
            listApartmentInfos = HomeService.HomeInfo_GetByTop("10", "HomeTypeID = 4", "");
