<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HomeManager.ascx.cs" Inherits="RealEstate.Admins.Modules.HomeManager" %>
...
<asp:Panel ID="pnUpdate" runat="server" Visible="False">
    <table class="TableUpdate" border="1">
        ...
        <tr>
            <th>
                <asp:Label ID="lblName" runat="server" Text="Tên nhà:"></asp:Label></th>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlHomeTypeName" runat="server"></asp:DropDownList>
            </td>
        </tr>
        ...
        <tr>
            <th>
                <asp:Label ID="Label3" runat="server" Text="Tên hãng:"></asp:Label></th>
            <td>
