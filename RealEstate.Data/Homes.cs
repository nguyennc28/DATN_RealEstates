...
namespace RealEstate.DataAccess
{
    public class Homes
    {
        ...
        //các thuộc tính của  lớp RealEstate
		...
		public Homes(string homeid)
		{
			this.HomeID = homeid;
		}
        public Homes(string homeid, string hometypeid, string realestateownersid, string realestateownerstypeid, string realestateid, string name, string transactionType, string tag, string description, string address, string price, string totalarea, string floorarea, string gargenarea, string homearea, string bedroomnumber, string tiernumber, string image1, string image2, string image3, string image4, string image5, string image6)
		{
			this.HomeID = homeid;
