    ...
    <div class="tabcont" style="margin-top: -30px;">
        ...
        <div id="tab1" class="tabcontent" align="justify">
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="span6">
                    <asp:TextBox ID="txtArea1" runat="server"></asp:TextBox><span class="note"> m2</span><span class="err"> <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtArea1" ErrorMessage="Bạn phải nhập vào tổng diện tích">*(băt buộc)</asp:RequiredFieldValidator></span>
                </div>
            </div>
            <div class="row">
                <div class="span3">
                ...
                <div class="span6">
                    <asp:TextBox ID="txtFloorArea1" runat="server"></asp:TextBox> <span class="note"> m2</span><span class="err"> <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtFloorArea1" ErrorMessage="Bạn phải nhập vào diện tích nền">*(băt buộc)</asp:RequiredFieldValidator></span>
                </div>
            </div>
            <%--<div class="row">
                <div class="span3">
            ...
            <div class="row">
                ...
                <div class="span6">
                    <asp:TextBox ID="txtPrice1" runat="server"></asp:TextBox><span class="note"> VNĐ</span> <span class="err"> <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtPrice1" ErrorMessage="Bạn phải nhập vào giá cả">*(băt buộc)</asp:RequiredFieldValidator></span>
                </div>
            </div>
            <div class="row">
                <div class="span3">
