...
{
    public partial class SaleWareHouse : System.Web.UI.UserControl
    {
        ...
        private void LoadSaleWareHouse()
        {
            string chuoi = "";
            List<HomeInfo> listApartmentInfos = new List<HomeInfo>();
            listApartmentInfos = HomeService.HomeInfo_GetByTop("10", "HomeTypeID = 6", "");
